# -*- coding: utf-8 -*-
"""
Created on Tue Aug 24 11:13:15 2021
...
# Creates an empty board with cells as 0
def create_board():
...
# Evaluates whether there is a winner or there is a tie 
def evaluate(board):
    winner = 0
...
def play_game():
    ...
    listy = [num for num in range(1,10)]


    players = []
    for i in range(2):
        players.append(random.choice(listy))
